...
TEXT_LOCALIZATION_YOLO_PATH = "saved_models/text_localization_2.pt"
DIS_MODEL_PATH = "best_model_1.pth"

# # Define the region of interest (ROI) and field of view (FOV) polygons
# ROI_POLYGON = np.array([(272, 477), (283, 356), (460, 349), (428, 476)])
# FOV_POLYGON = np.array([(107,60), (95, 450), (389,441), (401, 65)])
## US RACK SETUP 
# FOV_POLYGON = np.array([(27,7), (31,465), (368, 469), (346, 7)], dtype=np.int32)
# ROI_POLYGON = np.array([(27,7), (31,465), (368, 469), (346, 7)], dtype=np.int32)
...
# Define the region of interest (ROI) and field of view (FOV) polygons
# ROI_POLYGON = np.array([(272, 477), (283, 356), (460, 349), (428, 476)])
# FOV_POLYGON = np.array([(86, 3), (153, 419), (628, 466), (640, 0)])
...
# PLANOGRAM_IDS = ["61c03eef-840c-49df-ba20-0952553a4953","ff0aa8e3-5584-4776-8024-994161d14433"]

# COMPARTMENTS = {
#     "61c03eef-840c-49df-ba20-0952553a4953" : {
#         "FOV_POLYGON": np.array([(353,7), (372, 477), (0, 474), (6,6)], dtype=np.int32),
#         "ROI_POLYGON" : np.array([(353,7), (372, 477), (0, 474), (6,6)], dtype=np.int32)
#     }, 
#     "ff0aa8e3-5584-4776-8024-994161d14433": {
#         "FOV_POLYGON": np.array([(360,6), (395, 469), (640,480), (631, 9)], dtype=np.int32), 
#         "ROI_POLYON": np.array([(360,6), (395, 469), (640,480), (631, 9)], dtype=np.int32), 
    
#     }
# }
# # FOV_POLYGON = np.array([(260, 2), (230, 465), (1, 480), (6,2)], dtype=np.int32)

# COMPARTMENTS["61c03eef-840c-49df-ba20-0952553a4953"]["ROI_MASK"] = maskClass.generateMaskFromPolygon(COMPARTMENTS["61c03eef-840c-49df-ba20-0952553a4953"]["ROI_POLYGON"])
# COMPARTMENTS["61c03eef-840c-49df-ba20-0952553a4953"]["FOV_MASK"] = maskClass.generateMaskFromPolygon(COMPARTMENTS["61c03eef-840c-49df-ba20-0952553a4953"]["FOV_POLYGON"])
# COMPARTMENTS["ff0aa8e3-5584-4776-8024-994161d14433"]["ROI_MASK"] = maskClass.generateMaskFromPolygon(COMPARTMENTS["ff0aa8e3-5584-4776-8024-994161d14433"]["ROI_POLYGON"])
# COMPARTMENTS["ff0aa8e3-5584-4776-8024-994161d14433"]["FOV_MASK"] = maskClass.generateMaskFromPolygon(COMPARTMENTS["ff0aa8e3-5584-4776-8024-994161d14433"]["FOV_POLYGON"])
...
# ## Adding PUB-SUB details 
# topic-id: "product-onboarding-workstation"
# subscription-id: "product-onboarding-workstation-sub"
# project-id: "proj-qsight-asmlab"
